  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-[hsl(0, 0%, 0%)] hover:bg-primary/90 shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.97] transition-all font-display font-semibold",
        whatsapp: "bg-[hsl(142,70%,41%)] text-[hsl(0,0%,100%)] hover:bg-[hsl(142,70%,36%)] shadow-lg shadow-[hsl(142,70%,41%)]/25 active:scale-[0.97] transition-all font-display font-semibold",
      },
      size: {
